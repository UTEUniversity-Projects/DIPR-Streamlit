# ===============================================
# FULL CODE: Training YOLOv8 for Fruit Detection on Google Colab
...
# Sửa paths
content_modified = content.replace('path: ..', f'path: {dataset_dest}')
content_modified = content_modified.replace('train: ../train/images', 'train: train/images')
content_modified = content_modified.replace('val: ../valid/images', 'val: valid/images')
content_modified = content_modified.replace('test: ../test/images', 'test: test/images')
...
checkpoint_path = os.path.join(PROJECT_DIR, 'fruit_detector_roboflow/weights/last.pt')
...
print("\nValidating model...")
best_model_path = os.path.join(PROJECT_DIR, 'fruit_detector_roboflow/weights/best.pt')
...
results_img = os.path.join(PROJECT_DIR, 'fruit_detector_roboflow/results.png')
if os.path.exists(results_img):
    files.download(results_img)
    print(f"Downloaded: {results_img}")

confusion_matrix_img = os.path.join(PROJECT_DIR, 'fruit_detector_roboflow/confusion_matrix.png')
...
5. Test the fruit detection feature in your web app
""")